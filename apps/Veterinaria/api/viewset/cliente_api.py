...
from apps.Veterinaria.api.serializer.cliente_serializer import ClienteListSerializer, UpdateClienteSerializer, ClienteSerializer 
...
class UserViewSet(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        if self.queryset is None:
            self.queryset = self.model.objects.filter(estado=True).values('id', 'nombre','apellido','dni')
    ...
    def list(self, request):
        ...
        """
        users = self.get_queryset().values('id', 'nombre','apellido','dni')
